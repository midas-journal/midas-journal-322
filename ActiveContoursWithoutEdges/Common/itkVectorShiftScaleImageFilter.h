 ...
 * \brief Shift and scale the pixels in a vector image.
 *
...
public:
  ...
  typedef typename OutputImagePixelType::ComponentType OutputComponentType;

  /** Type to use form computations. */
  typedef typename NumericTraits<OutputComponentType>::RealType RealType;
...
//                   (Concept::AdditiveOperators<InputImagePixelType, RealType,
// RealType>));
