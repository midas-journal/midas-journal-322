...
=========================================================================*/
#ifndef __itkSparseMultiphaseSegmentationLevelSetImageFilter_h_
#define __itkSparseMultiphaseSegmentationLevelSetImageFilter_h_
...
class ITK_EXPORT SparseMultiphaseSegmentationLevelSetImageFilter
  : public MultiphaseSparseFieldLevelSetImageFilter< TInputImage,
    Image< TOutputPixel,
...
public:
  /** Inherited typedef from the superclass. Needs to be placed befroe
      the next macro. */
  typedef SparseMultiphaseSegmentationLevelSetImageFilter Self;
  ...
  typedef MultiphaseSparseFieldLevelSetImageFilter<TInputImage,
  ...
  itkTypeMacro( SparseMultiphaseSegmentationLevelSetImageFilter,
...
protected:
  ...
  virtual ~SparseMultiphaseSegmentationLevelSetImageFilter()
  {
  ...
  SparseMultiphaseSegmentationLevelSetImageFilter(const Self&);
...
#include "itkSparseMultiphaseSegmentationLevelSetImageFilter.txx"
#endif
