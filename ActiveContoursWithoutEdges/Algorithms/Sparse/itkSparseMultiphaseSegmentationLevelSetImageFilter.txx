...
#ifndef __itkSparseMultiphaseSegmentationLevelSetImageFilter_txx_
#define __itkSparseMultiphaseSegmentationLevelSetImageFilter_txx_

#include "itkSparseMultiphaseSegmentationLevelSetImageFilter.h"

namespace itk {

template < class TInputImage, class TFeatureImage, class TOutputPixel >
SparseMultiphaseSegmentationLevelSetImageFilter< TInputImage, TFeatureImage,
  TOutputPixel >
